...
if __name__ == "__main__":
    ...
    #model_test(imgdir="./test_images/", imgfile="5.bmp", ckdir=ckdir, outdir="./results/", type=type)
    
    #model_test(imgdir="./test_images/", imgfile="6.bmp", ckdir=ckdir, outdir="./results/", type=type)
    #model_test(imgdir="./test_images/", imgfile="7.bmp", ckdir=ckdir, outdir="./results/", type=type)
    #model_test(imgdir="./test_images/", imgfile="8.bmp", ckdir=ckdir, outdir="./results/", type=type)
    #model_test(imgdir="./test_images/", imgfile="770out.png", ckdir=ckdir, outdir="./results/", type=type)
    #model_test(imgdir="./test_images/", imgfile="880out.png", ckdir=ckdir, outdir="./results/", type=type)
